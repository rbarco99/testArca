...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    mostrarExamenes: function mostrarExamenes() {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get('/api/exams').then(function (response) {
                  _this.exams = response.data;
                  _this.cantidadExamenes = _this.exams.length;
                  console.log(_this.cantidadExamenes);
    ...
    borrarExamen: function borrarExamen(id) {
      var _this2 = this;

      var link = "/api/exams/" + id;
      console.log(link);

      if (confirm("¿Desea eliminar el examen?")) {
        this.axios["delete"](link).then(function (response) {
          _this2.mostrarExamenes();
        })["catch"](function (error) {
          console.log(error);
        });
      }
...
var render = function() {
  ...
  return _c("div", { staticClass: "container-fluid" }, [
      ...
      _c(
        ...
        [
          _c(
            "router-link",
            {
              staticClass: "btn btn-info btn-examen",
              attrs: {
    ...
    _vm._v(" "),
    _c("div", { staticClass: "container container-examenes" }, [
      _vm.cantidadExamenes == 0
        ? _c("div", { staticClass: "text-center" }, [
            _c("i", { staticClass: "fas fa-exclamation-triangle fa-4x" }),
            _vm._v(" "),
            _c("h4", [
              _vm._v("No hay examenes para mostar, prueba creando uno nuevo")
            ])
          ])
        : _vm._e(),
      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-md-8" }, [
      _c("h1", [_vm._v("Modulo de examenes ")])
    ])
  }
]
